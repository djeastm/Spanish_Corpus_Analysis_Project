...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_Dexie__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_indexeddb_export_import__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_indexeddb_export_import___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_indexeddb_export_import__);
...
__WEBPACK_IMPORTED_MODULE_0_Dexie__["a" /* default */].debug = true;
db.version(1).stores({
...
request_corpus.onreadystatechange = function() {
    if (request_corpus.readyState === 4) {
      ...
      var idb_db = db.backendDB(); // get native IDBDatabase object from Dexie wrapper
        ...
        __WEBPACK_IMPORTED_MODULE_1_indexeddb_export_import___default.a.exportToJsonString(idb_db, function(err, jsonString) {
            if(err)
                console.error(err);
            else {
                
            // console.log("Exported as JSON: " + jsonString);
                jsonString = '{"texts":'+JSON.stringify(corpus)+'}';
                //console.log("String: " + jsonString);
                __WEBPACK_IMPORTED_MODULE_1_indexeddb_export_import___default.a.clearDatabase(idb_db, function(err) {                
                    if(!err) // cleared data successfully                    
                        __WEBPACK_IMPORTED_MODULE_1_indexeddb_export_import___default.a.importFromJsonString(idb_db, jsonString, function(err) {
                            ...
                            if (!err)
                                ...
                                // db.texts.get({Datos_Transcripcion_resp_trans: "Daniela Mundaca"}).then (function (t) {
                                // console.log("Daniela's text: " + t.text);
                                // });
                        });
                });
            }
